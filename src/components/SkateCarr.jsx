            ...
            <div className="container">
                <Slide>
                    ...
                    <div className="each-slide-effect">
                        <div className='img-slide' style={{ 'backgroundImage': `url(${skates[0]})` }}>
                        </div>
                    ...
                    <div className="each-slide-effect">
                        <div className='img-slide' style={{ 'backgroundImage': `url(${skates[1]})` }}>
                        </div>
                    ...
                    <div className="each-slide-effect">
                        <div className='img-slide' style={{ 'backgroundImage': `url(${skates[2]})` }}>
                        </div>
                        <p className='sub-title'>Malba Tombstone Reissue 10.24" X 29.72"</p>
                        <p className='description-price'>129,99&euro;</p>
                    </div>
                    <div className="each-slide-effect">
                        <div className='img-slide' style={{ 'backgroundImage': `url(${skates[3]})` }}>
