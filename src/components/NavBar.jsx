            ...
            <nav id='nav-bar'>
                ...
                <div id="menuToggle" className='nav-bar-to-left'>
                    ...
                    <ul id="menu">
                        ...
                        <li><span id='side-menu-line'></span></li>
                ...
                <div className='nav-bar-to-right'>
                    ...
                    <img src="../img/_Icons/search-icon.png" alt="" />
                    <img src="../img/_Icons/Size = S, Color = White, Icon = Profile.png" alt="" />
                    <img src="../img/_Icons/Size = S, Color = White, Icon = Cart.png" alt="" />
